/****************************************************************************
** Meta object code from reading C++ file 'Sensor.hpp'
**
...
#error "The header file 'Sensor.hpp' doesn't include <QObject>."
...
Q_CONSTINIT const QMetaObject Sensor::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSensorENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<const SensorMetric &, std::false_type>
    >,
    nullptr
} };
...
void Sensor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->dataReady((*reinterpret_cast< std::add_pointer_t<SensorMetric>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Sensor::*)(const SensorMetric & );
            if (_t _q_method = &Sensor::dataReady; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Sensor::dataReady(const SensorMetric & _t1)
{
