/****************************************************************************
** Meta object code from reading C++ file 'Analyzer.hpp'
**
...
#error "The header file 'Analyzer.hpp' doesn't include <QObject>."
...
constexpr auto qt_meta_stringdata_CLASSAnalyzerENDCLASS = QtMocHelpers::stringData(
    "Analyzer",
    "analyzeData",
    "",
    "SensorMetric",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSAnalyzerENDCLASS[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       5,    0,   29,    2, 0x10a,    3 /* Public | MethodIsConst  */,
...
void Analyzer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->analyzeData((*reinterpret_cast< std::add_pointer_t<SensorMetric>>(_a[1]))); break;
        case 1: _t->reportPrint(); break;
        default: ;
        }
    }
}
